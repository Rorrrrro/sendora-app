          ...
          <div className="rounded-xl bg-[#FFFEFF] p-8 shadow-lg">
            <form className="space-y-6" onSubmit={handleSubmit} id="signup-form">
              ...
              <div>
                ...
                <div className="relative mt-1">
                  <input
                    ...
                    } px-3 py-2 pr-10 placeholder-gray-400 shadow-sm focus:border-primary focus:outline-none focus:ring-primary sm:text-sm`}
                    placeholder="••••••••"
                  />
                  <button
                    type="button"
                ...
                {formData.password && (
                  <div className="mt-2 text-xs">
                    <div className={`flex items-center ${isPasswordStrong(formData.password) ? "text-green-600" : "text-gray-500"}`}>
                      <span className={`mr-1 ${isPasswordStrong(formData.password) ? "text-green-600" : "text-gray-400"}`}>
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="flex w-full justify-center rounded-md bg-[#6c43e0] px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-[#4f32a7] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary disabled:opacity-50"
              >
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-gray-600">
                Déjà un compte ?{" "}
                <Link href="/login" className="font-medium text-[#6c43e0] hover:text-[#4f32a7]">
                  Se connecter
                </Link>
              </p>
            </div>
