    ...
    <div className="flex flex-col min-h-screen">
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center">
              <img src="/Sendora.png" alt="Sendora Logo" className="h-full w-auto object-contain" />
            </div>
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="relative mx-auto max-w-5xl">
            <div className="bg-gray-800 rounded-xl overflow-hidden shadow-2xl">
              <img src="/placeholder.svg?height=600&width=1200" alt="Dashboard Sendora" className="w-full h-auto" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              ...
              <a
                href="#create-account"
                className="inline-flex items-center bg-primary/90 hover:bg-primary text-white py-2 px-6 rounded-full transition-colors"
              >
      ...
      <section className="py-16 md:py-24 bg-gray-100 rounded-t-[40px]">
        <div className="container mx-auto px-4 text-center">
          ...
          <a
            href="#get-started"
            className="inline-flex items-center bg-primary text-white py-3 px-8 rounded-full hover:bg-primary/90 transition-colors"
          >
